...
# Generated on: Wed Sep 16 13:35:03 IST 2026 (Wed Sep 16 08:05:03 UTC 2026)
...
set logfile fv/siren_neuron/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/siren_neuron -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  ../rtl/inr_pkg.sv ../rtl/cordic_stage.sv ../rtl/cordic_wrapper.sv ../rtl/phase_folder.sv ../rtl/siren_act_unit.sv ../rtl/mac_unit.sv ../rtl/siren_neuron.sv
elaborate_design -golden -root {siren_neuron} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/siren_neuron/fv_map.v.gz
elaborate_design -revised -root {siren_neuron}
...
#add_name_alias fv/siren_neuron/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box siren_scaler -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.siren_neuron.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.siren_neuron.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.siren_neuron.rtl.fv_map.rpt
